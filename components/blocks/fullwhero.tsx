      ...
      >
       {/* <div className="row-start-2 lg:row-start-1 lg:col-span-3 text-center lg:text-left">
        ...
        <div className="flex items-center">
          <img src={data.image.src} alt="logo small" />
...
{/*            <div className="absolute text-white text-4xl font-boldtext-base">
              {data.tagline && (
                <h2
                  data-tinafield={`${parentField}.tagline`}
                  className="relative inline-block px-3 py-1 mb-8 text-md font-bold tracking-wide title-font z-20 bottom-20 left-1/2 -translate-x-1/2"
                >
                  {data.tagline}
                </h2>
              )}
          ...
          {data.text && (
            <div
              data-tinafield={`${parentField}.text`}
              className={`absolute text-white  text-base bottom-4 left-1/2 -translate-x-1/2`}
            >
              <h2
                data-tinafield={`${parentField}.tagline`}
...
export const fullwheroBlockSchema: TinaTemplate = {
  ...
  ui: {
    defaultItem: {
      ...
      text: "Phasellus fullwhero, libero eu finibus rutrum, risus risus accumsan libero, nec molestie urna dui a leo.",
    },
  },
  fields: [
    {
